...
const columns = [
  ...
  columnHelper.display({
    ...
    cell: ({ row }) => (
      <>
        <button onClick={() => onReturn(row.original.id)}>Return</button>
      </>
    )
  }),
];

function onReturn(record) {
  console.log(record);
}

function ListAndReturnBook() {
...
export default ListAndReturnBook;