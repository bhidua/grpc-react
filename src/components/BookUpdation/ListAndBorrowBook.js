...
const columns = [
  ...
  columnHelper.display({
    ...
    cell: ({ row }) => (
      <>
        <button onClick={() => onBorrow(row.original.id)}>Borrow</button>
      </>
    )
  }),
];

function onBorrow(record) {
  console.log(record);
}

function ListAndBorrowBook() {
...
export default ListAndBorrowBook;